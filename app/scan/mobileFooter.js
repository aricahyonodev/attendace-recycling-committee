    ...
    return (
      <div className="relative">
        <div className="absolute -top-5 inset-0 flex flex-col items-center justify-center">
          <div className="relative flex items-center justify-center bg-[#FFFFFF] shadow-lg p-4 rounded-full">
            <AiOutlineQrcode size={"2.4em"} color="#118911" />
          </div>
          <p className="text-[#939185] font-semibold text-base my-1">QR Code</p>
        </div>
      </div>
    );
}
